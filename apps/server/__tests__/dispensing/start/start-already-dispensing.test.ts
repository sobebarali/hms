...
describe("POST /api/dispensing/:prescriptionId/start - Already dispensing", () => {
	...
	beforeAll(async () => {
		...
		// Create a prescription that is already being dispensed
		...
		// Create existing dispensing record
	...
	it("returns 400/409 when prescription is already being dispensed", async () => {
