...
describe("POST /api/dispensing/:prescriptionId/start - Prescription cancelled", () => {
	...
	it("returns 400 when trying to start dispensing for cancelled prescription", async () => {
