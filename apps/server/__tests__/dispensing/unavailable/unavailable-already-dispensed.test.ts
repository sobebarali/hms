...
describe("POST /api/dispensing/:prescriptionId/unavailable - Already dispensed", () => {
	...
	beforeAll(async () => {
		...
		// Create dispensing with medicine already DISPENSED
	...
	it("returns 400 when medicine is already dispensed", async () => {
