...
describe("POST /api/dispensing/:prescriptionId/unavailable - With alternative", () => {
	...
	it("marks unavailable with alternative suggestion", async () => {
		const response = await request(app)
			...
			.send({
				medicineId,
				reason: "Out of stock",
				alternativeSuggested: "Generic equivalent available",
			});
