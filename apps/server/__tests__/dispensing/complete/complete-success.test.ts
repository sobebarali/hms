...
describe("POST /api/dispensing/:prescriptionId/complete - Complete success", () => {
	...
	beforeAll(async () => {
		...
		// Create dispensing record with ALL medicines DISPENSED
	...
	it("completes dispensing successfully", async () => {
