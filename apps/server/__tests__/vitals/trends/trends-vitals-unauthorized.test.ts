...
describe("GET /api/vitals/patient/:patientId/trends - Unauthorized", () => {
	...
	beforeAll(async () => {
		...
		await Patient.create({
			...
			patientId: `${context.hospitalId}-P-unauth-trends-${context.uniqueId}`,
			firstName: "Unauth",
			lastName: "TrendsPatient",
			dateOfBirth: new Date("1990-01-01"),
			gender: "MALE",
			phone: `+1-unauth-trends-${context.uniqueId}`,
			address: {
				street: "123 Test St",
				city: "Test City",
				state: "TS",
